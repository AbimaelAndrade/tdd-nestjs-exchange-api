...
describe('CurrenciesService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [CurrenciesService, 
        {
          provide: CurrenciesRepository,  useFactory: () => (currenciesRepositoryMock)
        }
      ],
    }).compile();
  ...
  describe('getCurrency()', () => {
    ...
    it('should be not throw if repository returns', async () => {
     ...
     it('should be called repository with corret params', async () => {
     ...
     it('should be return when repository return', async () => {
      (repository.getCurrency as jest.Mock)
  ...
  describe('createCurrency()', () => {
    ...
    it('should be called repository with corret params', async () => {
     ...
     it('should be return when repository return', async () => {
      (repository.createCurrency as jest.Mock)
        .mockResolvedValue(mockData);
  ...
  describe('updateCurrency()', () => {
    ...
    it('should be called repository with corret params', async () => {
     ...
     it('should be throw if value <= 0', async () => {
      ...
      .rejects.toThrow( new BadRequestException('The value must be greater zero.'));
    });
  });
